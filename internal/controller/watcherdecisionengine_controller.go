...
import (
	...
	"github.com/openstack-k8s-operators/watcher-operator/internal/watcherdecisionengine"
...
func (r *WatcherDecisionEngineReconciler) SetupWithManager(mgr ctrl.Manager) error {
	...
	if err := mgr.GetFieldIndexer().IndexField(context.Background(), &watcherv1beta1.WatcherDecisionEngine{}, memcachedInstanceField, func(rawObj client.Object) []string {
